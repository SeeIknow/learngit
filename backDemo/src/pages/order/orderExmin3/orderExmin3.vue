      ...
      <div class="infoItem">
        <el-row>
          <el-col :span="12">
            ...
            <span class="spa-right-span">{{listItem.inquiryOrderResponse.patientName == ''? '':listItem.inquiryOrderResponse.patientName}}</span>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content">
      ...
      <div class="infoItem">
        <el-row>
          <el-col :span="12">
            ...
            <span class="spa-right-span">已关闭</span>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <div class="grid-content">
            <span class="spa-left-span">关闭时间:</span>
            <span class="spa-right-span">{{listItem.inquiryOrderResponse.editdate  }}</span>
            </div>
          </el-col>
        </el-row>
      </div>
