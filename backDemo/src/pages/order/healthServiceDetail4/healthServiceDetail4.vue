  ...
  <div class="orderExmin">
    ...
    <div class="orderInfoDetail">
      ...
      <div class="infoItem button_box">
        <el-button type="primary" plain @click="openModal('successMod')">已到院</el-button>
        <el-button type="primary" plain @click="openModal('failMod')">未到院</el-button>
      </div>
    </div>
    <!-- 图片查看modal -->
    <el-dialog
    ...
    sureConfirm(val){
      switch(val){
        case 'successMod':
            ...
            this.postAlredayComeHospital(data).then(() =>{
        ...
        case 'failMod':
            ...
            this.postNotComeHospital(data1).then(() =>{
              this.$router.replace({name:'healthService'})
            })
            break;
      }
