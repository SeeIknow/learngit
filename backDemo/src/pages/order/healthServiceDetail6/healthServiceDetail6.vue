  ...
  <div class="orderExmin">
    ...
    <div class="orderInfoDetail">
        ...
        <el-row>
          <el-col :span="12">
            <div class="grid-content">
              ...
              <span class="spa-right-span">到院中</span>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content">
      ...
      <div class="infoItem button_box">
        <el-button type="primary" plain @click="openModal('successMod')">已治疗</el-button>
        <el-button type="primary" plain @click="openModal('failMod')">未治疗</el-button>
      </div>
    </div>
    <!-- 图片查看modal -->
    <el-dialog
    ...
    sureConfirm(val){
      switch(val){
        case 'successMod':
            ...
            //
            const data = {
              "confirmDate": this.dateVal,
              "id": this.$route.query.id
            }
            this.postAlredayTreatment(data).then(() =>{
        ...
        case 'failMod':
            ...
            //
            const data1 = {
              "reason": this.failReson,
              "id": this.$route.query.id
            }
            this.postNotTreatment(data1).then(() =>{
              this.$router.replace({name:'healthService'})
            })
            break;
      }
